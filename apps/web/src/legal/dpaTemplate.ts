// ============================================================
// DATA GOVERNANCE (#2) — Data Processing Agreement template.
//
// Canonical DPA text, kept as a string so the marketing DpaPage
// can render + download it without a backend round-trip. The
// same text is mirrored in docs/security/DPA-TEMPLATE.md (the
// repo artifact). This is a template for customer execution, not
// legal advice; bracketed [FIELDS] are filled at signing.
// ============================================================

export const DPA_TEMPLATE_MD = `# Data Processing Agreement
