      ...
      <div className="ahp-auth-brand" style={{ position: "relative", overflow: "hidden", background: "linear-gradient(150deg, #04042A, #1a1060)", color: "#fff", padding: 44, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ position: "relative", marginTop: 34, paddingTop: 22, borderTop: "1px solid rgba(255,255,255,.14)", display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <a href="#/auth" onClick={(e) => { e.preventDefault(); nav.go("#/auth"); }} style={{ fontSize: 13, fontWeight: 700, color: "#FF6E9C" }}>Start the live call →</a>
          </div>
        </div>
      </div>
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", overflowY: "auto" }}>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "8px 28px 40px" }}>
          <div style={{ width: "100%", maxWidth: 400 }}>
            ...
            <button onClick={submit} disabled={busy} style={{ width: "100%", height: 52, borderRadius: 9999, border: "1px solid var(--border)", background: "var(--card)", color: "var(--ink1)", fontSize: 15, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
            ...
            <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <button type="submit" disabled={busy} style={{ width: "100%", height: 52, marginTop: 6, border: "none", borderRadius: 9999, background: "#FF0660", color: "#fff", fontSize: 15, fontWeight: 700, letterSpacing: ".02em", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: "0 8px 24px rgba(255,6,96,.3)", opacity: busy ? 0.7 : 1 }}>{busy ? "Please wait" : isSignup ? "Create account" : "Sign in"}<Icon name="arrow_forward" style={{ fontSize: 20 }} /></button>
            </form>
