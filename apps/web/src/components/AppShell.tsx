...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "artifacts", icon: "layout-dashboard", label: "Artifacts" },
  ...
  return (
    ...
    >
      ...
      {(["layout-grid", "bell", "info", "settings"] as const).map((n) => {
        ...
        const title = n === "info" ? "About After Human" : n === "layout-grid" ? "Command Center" : n === "bell" ? "Approvals" : "AI Core";
        return (
        <button
          key={n}
      ...
      <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{ font: "var(--fw-bold) 14px var(--font-hud)", letterSpacing: "0.1em", color: "var(--jv-cyan-300)", whiteSpace: "nowrap" }}>TALK TO AFTER HUMAN</div>
