...
const timeEntries: Array<[string, string, string, number, string, number]> = [
  ["te1", "Command Center V1 — HUD layout", "After Human Design", 142, "Design", 0],
  ["te2", "Voice pipeline latency profiling", "After Human Core", 90, "Core dev", 1],
  ["te3", "Design review prep", "After Human Design", 55, "Design", 2],
  ["te4", "Code review — PR #482", "After Human Core", 69, "Review", 3],
  ["te5", "Release notes for v3.0.0", "After Human Core", 35, "Docs", 4],
];

const memoryFacts: Array<[string, string, string, number, number]> = [
  ["mf1", "Role", "Founder-engineer building the After Human assistant", 98, 0],
